...
public class Agregar_Empleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtE_Mail_Empleado = new javax.swing.JTextField();
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 50, -1));

        jLabel4.setText("Edad");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 50, 20));

        jLabel5.setText("RFC");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 40, -1));
        ...
        jPanel2.add(txtRFC, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 100, -1));
        jPanel2.add(txtE_Mail_Empleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 100, -1));
        ...
        jPanel2.add(btnEnviar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 70, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/d53a1dc4d5d66d83822acc888d7e9ff1.png"))); // NOI18N
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 70, 330, 360));
        ...
        jPanel2.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 100, -1));
        jPanel2.add(txtTelefonoEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 100, -1));
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        String id_emp,nomb,edad,rfc,dire,tele,e_mail;
        metodos mt = new metodos();
        id_emp=txtIDEmpleado.getText();
        nomb=txtNombreEmpleado.getText();
        edad=txtedadEmpleado.getText();
        rfc=txtRFC.getText();
        dire=txtDireccion.getText();
        tele=txtTelefonoEmpleado.getText();
        e_mail=txtE_Mail_Empleado.getText();
        mt.nuevoEmpleado(id_emp, nomb, edad, rfc, dire, tele, e_mail);
    ...
    private javax.swing.JTextField txtE_Mail_Empleado;
