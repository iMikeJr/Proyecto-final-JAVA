...
public class Agregar_Servicio extends javax.swing.JFrame {
    ...
    /** Creates new form Agregar_Servicio */
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtIdServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 100, -1));

        jLabel3.setText("Variante");
        ...
        jLabel6.setText("ID del proyecto");
        ...
        jPanel2.add(txtVariante, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 100, -1));
        jPanel2.add(txtIdEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 100, -1));
        ...
        jPanel2.add(btnEnviar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 70, -1));
        ...
        jPanel2.add(DateInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 100, -1));
        jPanel2.add(DateFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 100, -1));

        jLabel10.setText("ID del empleado");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, -1, -1));
        jPanel2.add(txtIdCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 100, -1));

        jLabel11.setText("ID del cliente");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, -1, -1));
        jPanel2.add(txtIdProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, 100, -1));
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        String idSerivce,variante,FechaFinal,FechaInicio,ID_Empleado,Id_cliente,Id_proyecto;
        idSerivce=txtIdServicio.getText();
        variante=txtVariante.getText();
        FechaFinal="";
        FechaFinal+=DateFin.getCalendar().get(Calendar.YEAR)+"-";
        FechaFinal+=(DateFin.getCalendar().get(Calendar.MONTH)+1)+"-";
        FechaFinal+=DateFin.getCalendar().get(Calendar.DAY_OF_MONTH)+"-";
        FechaInicio="";
        FechaInicio+=DateInicio.getCalendar().get(Calendar.YEAR)+"-";
        FechaInicio+=(DateInicio.getCalendar().get(Calendar.MONTH)+1)+"-";
        FechaInicio+=DateInicio.getCalendar().get(Calendar.DAY_OF_MONTH)+"-";
        ID_Empleado=txtIdEmpleado.getText();
        Id_cliente=txtIdCliente.getText();
        Id_proyecto=txtIdProyecto.getText();
        metodos p = new metodos();
        p.nuevoServicio(idSerivce, variante, FechaFinal, FechaInicio, ID_Empleado, Id_cliente, Id_proyecto);
