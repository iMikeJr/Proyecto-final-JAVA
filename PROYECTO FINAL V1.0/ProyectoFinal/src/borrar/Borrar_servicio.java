 ...
 * @author eduar
 */
public class Borrar_servicio extends javax.swing.JFrame {

    /**
     * Creates new form Borrar_servicio
     */
    public Borrar_servicio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Borrar Servicio");
        ...
        txtVarianteServicio.setEditable(false);
        ...
        jPanel2.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 90, -1));
        ...
        txtIdEmplead.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Borrar_servicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Borrar_servicio().setVisible(true);
            }
        });
    }
