 ...
 * @author eduar
 */
public class Listar_Proyectos extends javax.swing.JFrame {

    /**
     * Creates new form Listar_Proyectos
     */
    public Listar_Proyectos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        TablaCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tiempo", "Fecha Inicio", "Variante", "Descripcion"
            }
        ) {
    ...
    private void lblIconBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblIconBuscarMouseClicked
        ...
        String code;
        String[]columNames={"ID","Tiempo","Fecha de inicio","Variante","Descripcion"};
        Metodos_Listar_sin_busqueda_personalizada p = new Metodos_Listar_sin_busqueda_personalizada();
        dtClienteByItsID=p.getProyectoForPrintinTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listar_Proyectos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listar_Proyectos().setVisible(true);
            }
        });
    }
