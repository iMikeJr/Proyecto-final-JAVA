 ...
 * @author eduar
 */
public class listar_main extends javax.swing.JFrame {

    /**
     * Creates new form listar_main
     */
    public listar_main() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblListarProyecto = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        lblListarCliente = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        lblListarEmpleado = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jLabel10 = new javax.swing.JLabel();
        lblListarServicio = new javax.swing.JLabel();
        ...
        lblListarProyecto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/listar-el-simbolo-del-boton-cuadrado-para-la-interfaz_1.png"))); // NOI18N
        lblListarProyecto.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblListarProyecto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblListarProyectoMouseClicked(evt);
            }
        });
        jPanel1.add(lblListarProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 12, -1, -1));
        ...
        lblListarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/listar-el-simbolo-del-boton-cuadrado-para-la-interfaz_1.png"))); // NOI18N
        lblListarCliente.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblListarCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblListarClienteMouseClicked(evt);
            }
        });
        jPanel1.add(lblListarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 94, -1, -1));
        ...
        lblListarEmpleado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/listar-el-simbolo-del-boton-cuadrado-para-la-interfaz_1.png"))); // NOI18N
        lblListarEmpleado.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblListarEmpleado.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblListarEmpleadoMouseClicked(evt);
            }
        });
        jPanel1.add(lblListarEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 176, -1, -1));
        ...
        jLabel7.setText("Listar empleado");
        ...
        jLabel8.setText("Listar cliente");
        ...
        jLabel10.setText("Listar Proyecto");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 40, -1, -1));

        lblListarServicio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/listar-el-simbolo-del-boton-cuadrado-para-la-interfaz_1.png"))); // NOI18N
        lblListarServicio.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblListarServicio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblListarServicioMouseClicked(evt);
            }
        });
        jPanel1.add(lblListarServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 60, -1, -1));
        ...
        jLabel13.setText("Listar servicio");
    ...
    private void lblListarProyectoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblListarProyectoMouseClicked
      Listar_Proyectos obj = new Listar_Proyectos();
      obj.setVisible(true);
      this.dispose();
    }//GEN-LAST:event_lblListarProyectoMouseClicked

    private void lblListarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblListarClienteMouseClicked
        Listar_Clientes obj = new Listar_Clientes();
        obj.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_lblListarClienteMouseClicked

    private void lblListarEmpleadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblListarEmpleadoMouseClicked
      Listar_Empleados obj = new Listar_Empleados();
      obj.setVisible(true);
      this.dispose();
    }//GEN-LAST:event_lblListarEmpleadoMouseClicked

    private void lblListarServicioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblListarServicioMouseClicked
        ListarServicios OBJ  = new ListarServicios();
        OBJ.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_lblListarServicioMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listar_main.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listar_main().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblListarEmpleado;
    private javax.swing.JLabel lblListarProyecto;
    private javax.swing.JLabel lblListarServicio;
