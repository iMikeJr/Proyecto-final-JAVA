...
public class Listar_Empleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TablaCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Edad", "Rfc", "Direccion", "Telefono", "E_Mail"
            }
        ));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 540, 230));

        jLabel4.setFont(new java.awt.Font("Agency FB", 0, 18)); // NOI18N
        jLabel4.setText("Listar empleados");
    ...
    private void lblIconBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblIconBuscarMouseClicked
       ...
       Object [][] dtClienteByItsID;
        String code;
        String[]columNames={"ID","Nombre","Edad","Rfc","Direccion","Telefono","E_mail"};
        Metodos_Listar_sin_busqueda_personalizada p = new Metodos_Listar_sin_busqueda_personalizada();
        dtClienteByItsID=p.getEmpleadoForPrintinTable();
