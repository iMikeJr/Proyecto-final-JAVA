...
public class Actualizar_Empleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 80, 20));
        jPanel1.add(txtIDEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 100, -1));
        ...
        jPanel1.add(txtNombreEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 100, -1));

        jLabel5.setText("Edad");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, -1, 20));
        jPanel1.add(txtEdadEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 100, -1));
        jPanel1.add(txtRfcEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 100, -1));

        Rfc.setText("Rfc");
        jPanel1.add(Rfc, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, -1, -1));

        jLabel7.setText("Direccion");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, -1, -1));
        jPanel1.add(txtDireccionEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 100, -1));
        jPanel1.add(txtTelEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 100, -1));
        ...
        jPanel1.add(txtEmailEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, 100, -1));

        btnActualizaremp.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel1.add(btnActualizaremp, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 90, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 310, 80, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 330, 360));
    ...
    private void btnActualizarempActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarempActionPerformed
        ...
        if(i==JOptionPane.YES_OPTION){
            ...
            a=txtNombreEmpleado.getText();
            b=txtEdadEmpleado.getText();
            c=txtRfcEmpleado.getText();
            d=txtDireccionEmpleado.getText();
            e=txtTelEmpleado.getText();
            f=txtEmailEmpleado.getText();
            
            p.ActualizaEmpleados(empleado, a, b, c, d, e, f);
